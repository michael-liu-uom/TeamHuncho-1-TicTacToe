...
class State:
    ...
    def winner(self):
        """
        Return 1 for player one, -1 for player two, None for not ended
        :return:
        """
        # row
    ...
    def giveReward(self):
        ...
        if result == 1:
            ...
            """
            Would be interesting to find out how changing the rewards here will affect
            the performance.
            """
...
class Player:
    def __init__(self, name, exp_rate=0.3):
        """
        Will need to explore the configurations.
          - exp_rate (explore rate) is not updated
        """
        self.name = name
